...
const AuroraMessageHandler: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (drones.medium >= 3 && energy.advancedSolar >= 1 && 
        !techCenter.unlocked && !shownMessages.has("tech_center_available")) {
    ...
    if (techCenter.upgrades.reinforcedBasicDrones === 1 && !shownMessages.has("reinforced_basic_unlocked")) {
    ...
    if (techCenter.upgrades.reinforcedMediumDrones === 1 && !shownMessages.has("reinforced_medium_unlocked")) {
    ...
    if (techCenter.upgrades.reinforcedAdvancedDrones === 1 && !shownMessages.has("reinforced_advanced_unlocked")) {
    ...
    if (techCenter.upgrades.researchEfficiency === 1 && !shownMessages.has("research_efficiency_unlocked")) {
    ...
    if (techCenter.upgrades.advancedAnalysis === 1 && !shownMessages.has("advanced_analysis_unlocked")) {
    ...
    if (techCenter.upgrades.algorithmOptimization === 1 && !shownMessages.has("algorithm_optimization_unlocked")) {
