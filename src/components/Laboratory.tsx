...
const newTechTree = [
  ...
  { id: 'automatedDistribution', branch: 'logistics', tier: 4, row: 1, title: 'Distribución Automatizada', description: 'Reduce el consumo de energía de las unidades de almacenamiento.', effect: (l: number) => `-${l * 10}% Consumo Almacenes`, cost: 800, maxLevel: 3, requirements: ['cargoDrones'] },
