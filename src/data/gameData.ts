...
export const gameData: GameData = {
  ...
  storage: {
    ...
    mediumStorage: { costs: { scrap: 1000 }, time: 50, prerequisites: (s) => s.storage.basicStorage >= 3 },
    advancedStorage: { costs: { scrap: 10000 }, time: 200, prerequisites: (s) => s.storage.mediumStorage >= 1 },
