...
export const gameData: GameData = {
  workshop: {
    ...
    reinforcedAdvanced: { costs: { scrap: 7000, metalRefinado: 30 }, time: 300, prerequisites: (s) => s.techCenter.upgrades.reinforcedAdvancedDrones > 0, scrapProduction: 80, energyConsumption: 12 },
    golem: { costs: { scrap: 75000, aceroEstructural: 5 }, time: 600, prerequisites: (s) => s.techCenter.upgrades.golemChassis > 0 && s.workshop.drones.reinforcedAdvanced >= 5, energyConsumption: 50 },
